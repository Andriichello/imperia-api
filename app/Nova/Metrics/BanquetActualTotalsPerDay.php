...
/**
 * BanquetActualTotalsPerDay class
 */
class BanquetActualTotalsPerDay extends Trend
{
    public function __construct($component = null)
    {
        parent::__construct($component);

        $this->name = __('nova.metrics.banquets_actual_total');
    }
    ...
    public function calculate(NovaRequest $request): TrendResult
    {
        ...
        Banquet::query()
            ...
            ->each(function (Banquet $banquet) use (&$trend) {
                ...
                $trend[$formatted] += $banquet->actual_total;
            });
    ...
    {
        return 'banquet-actual-totals-per-day';
    }
}
