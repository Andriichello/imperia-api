...
class DishController extends CrudController
{
     ...
     *   @OA\Parameter(name="filter[restaurant_id]", required=false, in="query", example="1",
     *     @OA\Schema(type="string"), description="Restaurant ID to filter dishes by."),
     ...
     *   @OA\Parameter(name="filter[menu_ids]", required=false, in="query", example="1,2,3",
     *     @OA\Schema(type="string"), description="Coma-separated list of menu ids."),
