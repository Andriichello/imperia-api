 ...
 */
class StoreDishRequest extends StoreRequest
{
    /**
    ...
    {
        return SameRestaurant::make($this->user(), DishMenu::class)
            ->onlyAdmins()
            ->validate('id', $this->get('menu_id'), fn() => null);
    }

    /**
     * @OA\Schema(
     *   schema="StoreDishRequest",
     *   description="Store dish request.",
     *   required={"menu_id", "title", "price"},
