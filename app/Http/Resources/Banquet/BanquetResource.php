...
class BanquetResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'advance_amount_payment_method' => $this->advance_amount_payment_method,
            'is_birthday_club' => $this->is_birthday_club,
            'with_photographer' => $this->with_photographer,
     ...
     *     "actual_total", "advance_amount_payment_method", "is_birthday_club", "with_photographer",
     *     "adults_amount", "adult_ticket_price", "children_amount", "child_ticket_price",
     ...
     *     nullable=true, example="card"),
     *   @OA\Property(property="actual_total", type="number", nullable=true, example=2502.55),
