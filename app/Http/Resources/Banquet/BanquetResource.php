...
class BanquetResource extends JsonResource
{
     ...
     *   required = {"id", "type", "state", "available_states", "is_editable", "title", "description", "start_at",
     *     "end_at", "paid_at", "advance_amount", "total", "discounted_total", "order_id", "creator_id", "customer_id"},
     ...
     *   @OA\Property(property="discounted_total", type="float", example=125.55),
