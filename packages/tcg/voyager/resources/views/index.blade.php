    ...
    @if(isset($google_analytics_client_id) && !empty($google_analytics_client_id))
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                /**
                 * Creator a new ActiveUsers instance to be rendered inside of an
                ...
                /**
                 * Creator a new ViewSelector2 instance to be rendered inside of an
                ...
                /**
                 * Creator a new canvas inside the specified element. Set it to be the width
                ...
                /**
                 * Creator a visual legend inside the specified element based off of a
                 * Chart.js dataset.
