...
/* harmony import */ var _vendor_laravel_nova_resources_js_mixins_Filterable_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../vendor/laravel/nova/resources/js/mixins/Filterable.js */ "../../vendor/laravel/nova/resources/js/mixins/Filterable.js");
/* harmony import */ var _vendor_laravel_nova_resources_js_util_escapeUnicode_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../vendor/laravel/nova/resources/js/util/escapeUnicode.js */ "../../vendor/laravel/nova/resources/js/util/escapeUnicode.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  'resource', 'resourceId', 'viaResource', 'viaResourceId', 'viaRelationship',
  // The following props are available on index as well...
  'resourceName'],
  mixins: [_vendor_laravel_nova_resources_js_mixins_Filterable_js__WEBPACK_IMPORTED_MODULE_1__["default"]],
  data: function data() {
    var settings = this.card.settings;
    var fields = this.relevantFields(this.card.fields, this.cachedAttributes());
    var attributes = this.getCheckedAttributes(fields);
    return {
      settings: settings,
      fields: fields,
  ...
  methods: {
    ...
    getAttributes: function getAttributes(fields) {
      return fields.map(function (f) {
        return f.attribute;
      });
    },
    getCheckedAttributes: function getCheckedAttributes(fields) {
      return this.getAttributes(this.getChecked(fields));
    },
    applyFields: function applyFields() {
      var query = this.getEncodedQueryString();
    ...
    toggleField: function toggleField(field) {
      ...
      if (field.checked) {
        ...
        this.attributes = this.attributes.filter(function (a) {
          return a !== field.attribute;
        });
      }
    },
    relevantFields: function relevantFields(provided, stored) {
      console.log('provided: ', provided);
      console.log('stored: ', stored);
      if (!Array.isArray(stored) || !stored.length) {
        return provided;
      }
      var fields = !Array.isArray(provided) || !provided.length ? [] : provided;
    ...
    updateColumnsFilter: function updateColumnsFilter() {
      var filter = this.$store.getters["".concat(this.resourceName, "/getFilter")](this.settings.filter["class"]);
      if (filter == null) {
      ...
      if (!this.arrayCompare(filter.currentValue, this.attributes)) {
        ...
        filter.currentValue = this.attributes.map(function (a) {
          return a;
        });
      } else {
    ...
    cache: function cache(cacheKey, value) {
      var property = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : undefined;
      try {
        if (property == null) {
          localStorage.setItem(cacheKey, JSON.stringify(value));
          return true;
        }
        var item = JSON.parse(localStorage.getItem(cacheKey));
        item[property] = value;
    ...
    cached: function cached(cacheKey) {
    ...
    decodeObject: function decodeObject(data) {
      try {
    ...
    encodeObject: function encodeObject(data) {
      return btoa((0,_vendor_laravel_nova_resources_js_util_escapeUnicode_js__WEBPACK_IMPORTED_MODULE_2__.escapeUnicode)(JSON.stringify(data)));
    },
    cachedAttributes: function cachedAttributes() {
      return this.cached(this.card.settings.cache.key, 'attributes');
    },
    getEncodedQueryString: function getEncodedQueryString() {
      return this.encodeObject(_objectSpread({}, this.attributes));
    },
    cachedEncodedQueryString: function cachedEncodedQueryString() {
      return this.cached(this.card.settings.cache.key, 'query');
    },
    arrayCompare: function arrayCompare(left, right) {
      if (!Array.isArray(left) || !Array.isArray(right) || left.length !== right.length) {
        return false;
      }

      // .concat() to not mutate arguments
      var arr1 = left.concat().sort();
      var arr2 = right.concat().sort();
...
var _hoisted_2 = {
  "class": "header-collapse flex justify-start items-center"
};
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_card, {
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["btn-collapse flex justify-center items-center rounded", {
          'rotated': !$data.isCollapsed
        }]),
        ...
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
          key: index,
          "class": "column"
        }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(column, function (field) {
...
Nova.booting(function (app, store) {
  app.component('columns-card', _components_Card__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
...
/* harmony import */ var _var_www_imperia_api_nova_components_ColumnsCard_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkandriichello_columns_card"] = self["webpackChunkandriichello_columns_card"] || [];
