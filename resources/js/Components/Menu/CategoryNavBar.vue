  ...
  <div class="w-full flex flex-col justify-center shadow-md mb-2"
    ...
    <div class="w-full flex justify-center items-start">
      <div
        ref="scrollRef"
        :class="[
          'max-w-full flex justify-start items-start gap-2 p-2 transition-all duration-200 overflow-x-auto overflow-y-hidden',
          hasOverflow ? 'pr-16' : ''
        ]"
      ...
      <div class="w-fit h-full bg-base-100 p-2 absolute right-0"
